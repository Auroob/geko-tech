...
const AboutPoint = () => {
  ...
  return (
    <section className="my-10">
      {points.map((point) => (
        <div key={point.number} className="grid grid-cols-[auto_1fr] gap-4 px-4 mb-6 py-4 rounded-2xl shadow-xl border border-geko-grey transform transition duration-500 hover:scale-105">
          ...
          <div>
            ...
            <p className="font-light text-geko-grey">{point.description}</p>
          </div>
        </div>
      ))}
    </section>
