...
const StaffAugPackages = () => {
    const recSolPackagesData = [
      [
        {
          title: "Standard",
          subtitle: "Project Consultation & Planning",
          description: [
        ...
        {
          title: "Lean",
          subtitle: "Collaborative Project Development",
          description: [
              "Customized technical questions for initial interviews.",
              "Video interview recording and delivery.",
              "Streamlined candidate assessment.",
        ...
        {
          title: "Premium",
          subtitle: "Full-Scale Project Execution",
          description: [
              "Customized technical questions for initial interviews.",
              "Video interview recording and delivery.",
              "Streamlined candidate assessment.",
          ...
          {recSolPackagesData[0].map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="text-white text-center mb-4 sm:text-5xl lg:text-4xl lg:leading-normal font-light">
                  {item.subtitle}
                </h2>
                <h5 className="text-lg px-4 text-center text-geko-grey font-regular leading-loose animated-paragraph">
                  {item.benefit}
                </h5>
...
export default StaffAugPackages;
